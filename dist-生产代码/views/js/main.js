...
document.addEventListener('DOMContentLoaded', function() {
  var s = 256;
  var pizzasHeight = Math.ceil(window.innerHeight / s);
  var pizzasWidth = Math.ceil(document.body.offsetWidth / s);
  var pizzasNum = pizzasHeight * pizzasWidth;
  ...
  for (var i = 0; i < pizzasNum; i++) {
    ...
    elem.basicLeft = (i % pizzasWidth) * s;
    elem.style.top = (Math.floor(i / pizzasWidth) * s) + 'px';
